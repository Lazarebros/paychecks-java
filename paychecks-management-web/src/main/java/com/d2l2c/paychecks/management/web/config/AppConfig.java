 ...
 * 
 */
package com.d2l2c.paychecks.management.web.config;
...
@EnableWebMvc
@PropertySource(value = "file:${WEB_APP_CONF_DIR}/paychecks/properties/${APP_ENV}-paychecks-management-web.properties",ignoreResourceNotFound = true)
