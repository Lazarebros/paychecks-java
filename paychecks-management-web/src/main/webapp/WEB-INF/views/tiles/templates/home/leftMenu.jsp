		...
		<div class="panel panel-default">
			...
			<div id="collapseOne" class="panel-collapse collapse">
				<div class="panel-body">
					<table class="table">
						<c:forEach var="comapany" items="${companies}">
							<tr>
								<td>
									<%-- <h:commandLink action="#{homeController.filterCompany(comapany.id)}" value="#{comapany.code}"/> --%>
									<label class="side-menu-item"><input type="checkbox" id="company" name="checkbox"><span class="side-menu-item">${comapany}</span></label>
								</td>
							</tr>
						</c:forEach>
					</table>
